...
const DalanJilHunNew = ({ refreshDalHun, selectedHumrug, selectedDans }) => {
    // 🔥 MODAL НЭЭГДЭХ ҮЕД ШАЛГАХ
    // ===============================
    useEffect(() => {
        const modalEl = document.getElementById("DalanJilNew");
        if (!modalEl) return;
    ...
    return (
        <>
            <div className="modal" id="DalanJilNew">
