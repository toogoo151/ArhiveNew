...
const DalanJilhunChildEdit = (props) => {
    ...
    const saveComand = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                if (window.$) {
                    window.$("#dalanHunChildEdit").modal("hide");
                }

                props.refreshdalanHunChild(props.parentID);
            })
            .catch((err) => {
    ...
    const deleteOldFile = (file) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .post("/delete/DalanJilhunChildFile", {
                        id: props.changeDataRow.id,
                        file_url: file.url,
                    })
                    .then((res) => {
    ...
    return (
        <>
            <div className="modal" id="dalanHunChildEdit">
...
export default DalanJilhunChildEdit;
