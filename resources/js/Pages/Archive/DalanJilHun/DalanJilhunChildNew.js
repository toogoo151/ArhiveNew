...
const DalanJilhunChildNew = ({ _parentID, refreshdalanHunChild }) => {
    ...
    useEffect(() => {
        refreshdalanHunChild(_parentID);
    }, [_parentID]);
    ...
    return (
        <>
            <div className="modal" id="dalanHunNew">
...
export default DalanJilhunChildNew;
