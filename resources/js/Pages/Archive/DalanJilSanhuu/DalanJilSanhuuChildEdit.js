...
const DalanJilSanhuuChildEdit = (props) => {
    ...
    const saveComand = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                if (window.$) {
                    window.$("#dalanSanhuuChildEdit").modal("hide");
                }

                props.refreshdalanSanhuuChild(props.parentID);
            })
            .catch((err) => {
    ...
    const deleteOldFile = (file) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .post("/delete/DalanJilsanhuuChildFile", {
                        id: props.changeDataRow.id,
                        file_url: file.url,
                    })
                    .then((res) => {
    ...
    return (
        <>
            <div className="modal" id="dalanSanhuuChildEdit">
...
export default DalanJilSanhuuChildEdit;
