...
const DalanJilSanhuuNew = ({
    ...
    // ===============================
    useEffect(() => {
        const modalEl = document.getElementById("DalanJilSanhuuNew");
        if (!modalEl) return;
    ...
    return (
        <>
            <div className="modal" id="DalanJilSanhuuNew">
...
export default DalanJilSanhuuNew;
