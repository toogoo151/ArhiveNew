...
const TurIltsChildNew = ({ _parentID, refreshTurIltsChild }) => {
    ...
    return (
        <>
            <div className="modal" id="turIltsChildNew">
...
export default TurIltsChildNew;
