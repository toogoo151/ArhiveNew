...
const TurIltsChildEdit = (props) => {
    ...
    const saveComand = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                if (window.$) {
                    window.$("#turIltsChildEdit").modal("hide");
                }

                props.refreshTurIltsChild(props.parentID);
            })
            .catch((err) => {
    ...
    return (
        <>
            <div className="modal" id="turIltsChildEdit">
...
export default TurIltsChildEdit;
