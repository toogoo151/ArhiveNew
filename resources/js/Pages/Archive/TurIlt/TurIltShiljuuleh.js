...
// import BaingaPrint from "./BaingaPrint";
import TurPrint from "./TurPrint";

const TurIltShiljuuleh = ({
    selectedHumrug,
    selectedDans,
    changeDataRow,
    getTurIlt,
    ...
    const removeSelectedRow = (rowId) => {
        ...
        const updatedIndexes = updatedRows.map((row) =>
            getTurIlt.findIndex((r) => r.id === row.id)
        );
...
export default TurIltShiljuuleh;
const columns = [
    {
        name: "id",
        label: "№",
