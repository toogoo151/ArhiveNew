...
const ArhivTRIltsChild = (props) => {
    ...
    const btnEdit = () => {
        ...
        const rowData = getTurIltsChild[rowIndex];
    ...
    const btnDelete = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .post("/delete/TurIltChild", {
                        id: getTurIltsChild[getRowsSelected[0]].id,
                    })
                    .then((res) => {
                        Swal.fire(res.data.msg);
            ...
            <div className="row clearfix">
                <div className="info-box">
                    <div className="col-md-12">
                        ...
                        <MUIDatatable
                            data={getTurIltsChild}
                            setdata={setTurIltsChild}
                            columns={columns}
                            onRowClick={(rowData, rowMeta) => {
                                const selectedRow =
                                    getTurIltsChild[rowMeta.dataIndex];
                            ...
                            btnEdit={btnEdit}
                            modelType={showModal}
                            editdataTargetID={"#TurIltsChildEdit"}
                            btnDelete={btnDelete}
                            avgColumnIndex={-1}
                            avgColumnName={"email"}
                            avgName={"Дундаж: "}
...
export default ArhivTRIltsChild;
const columns = [
    {
        name: "id",
        label: "№",
