...
const TurIltNew = ({ refreshTurIlt, selectedHumrug, selectedDans }) => {
    // 🔥 MODAL НЭЭГДЭХ ҮЕД ШАЛГАХ
    // ===============================
    useEffect(() => {
        const modalEl = document.getElementById("TurNew");
        if (!modalEl) return;
