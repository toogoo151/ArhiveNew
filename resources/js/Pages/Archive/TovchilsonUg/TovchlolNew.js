...
const TovchlolNew = ({ refreshTovchlol }) => {
    ...
    return (
        <div className="modal" id="TovchlolNew">
            <div className="modal-dialog modal-lg">
                <div className="modal-content">

                    <div className="modal-header">
                        <h4 className="modal-title">Товчлол нэмэх</h4>
