...
const TurNuutsChild = (props) => {
    ...
    const btnDelete = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .post("/delete/TurNuutsChild", {
                        id: getTurNuutsChild[getRowsSelected[0]].id,
                    })
                    .then((res) => {
                        Swal.fire(res.data.msg);
    ...
    const importExcel = (file) => {
        ...
        axios
            ...
            .then((res) => {
                ...
                refreshTurNuutsChild(); // <-- Table refresh хийж өгөгдөл шинэчлэгдэх
            })
            .catch((err) => {
