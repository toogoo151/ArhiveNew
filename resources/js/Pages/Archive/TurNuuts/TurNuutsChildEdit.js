...
const TurNuutsChildEdit = (props) => {
    ...
    const saveComand = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                if (window.$) {
                    window.$("#TurNuutsChildEdit").modal("hide");
                }

                props.refreshTurNuutsChild(props.parentID);
            })
            .catch((err) => {
    ...
    return (
        <>
            <div className="modal" id="TurNuutsChildEdit">
...
export default TurNuutsChildEdit;
