...
const TurNuutsChildNew = ({ _parentID, refreshTurNuutsChild }) => {
    ...
    useEffect(() => {
        refreshTurNuutsChild(_parentID);
    }, [_parentID]);
    ...
    return (
        <>
            <div className="modal" id="TurNuutsChildNew">
...
export default TurNuutsChildNew;
