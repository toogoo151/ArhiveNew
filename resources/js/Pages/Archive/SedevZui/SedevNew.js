...
const SedevNew = ({ refreshSedevzui }) => {
    ...
    const schema = Yup.object().shape({
        ...
        zaagch_tobchlol: Yup.string().required("Товчлол оруулна уу"),
    });
            ...
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    ...
                    <div className="modal-header">
                        <h4 className="modal-title">Сэдэв зүй нэмэх</h4>
