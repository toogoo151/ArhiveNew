...
const DalanJilSanhuuEdit = ({
    ...
    const saveComand = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                sethn_tailbar("");
                if (window.$) {
                    window.$("#DalanJilSanhuuEdit").modal("hide");
                }
    ...
    return (
        <>
            <div className="modal" id="DalanJilSanhuuEdit">
...
export default DalanJilSanhuuEdit;
